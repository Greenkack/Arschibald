...
def integrate_selected_charts_into_pdf(
    ...
    try:
        ...
        # 4. Financial Tools
        financial_tools_results = pdf_options.get(
            'financial_tools_results', {})
...
def ensure_all_charts_in_analysis_results(
    ...
    if charts_added > 0:
        logging.info(
            f"✅ {charts_added} Charts von calculation_results nach analysis_results kopiert")
...
def prepare_complete_analysis_results(
    ...
    logging.info(
        f"✅ Vollständige analysis_results vorbereitet: {chart_count} Charts verfügbar")
