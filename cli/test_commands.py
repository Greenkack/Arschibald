...
def run_unit_tests():
    ...
    console.print("[green][OK] All unit tests passed[/green]")
...
def run_integration_tests():
    ...
    console.print("[green][OK] All integration tests passed[/green]")
...
def run_e2e_tests():
    ...
    console.print("[green][OK] All E2E tests passed[/green]")
