...
def test_create_task_validation():
    ...
    try:
        ...
        try:
            ...
            """, ("",))
            conn.commit()
            print("   ⚠️  Leerer Titel wurde akzeptiert (sollte validiert werden)")
        ...
        print(f"   ℹ️  Ungültiger Status gespeichert: '{status}' (App sollte validieren)")
...
def run_all_tests():
    ...
    if failed == 0:
        ...
        print(f"\n⚠️  {failed} Test(s) fehlgeschlagen - bitte überprüfen!")
