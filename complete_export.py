...
def get_complete_chart_mapping() -> dict[str, str]:
    ...
    return {
        ...
        'pv_usage_chart_bytes': " PV-Nutzung (calculations.py)",
        ...
        'break_even_scenarios_chart_bytes': "⏱ Break-Even Szenarien (calculations.py)",
        'technical_degradation_chart_bytes': "Technische Degradation (calculations.py)",
        'maintenance_schedule_chart_bytes': " Wartungsplan (calculations.py)",
        ...
        'optimization_chart_bytes': " Optimierungs-Analyse (analysis.py)",
        ...
        'comparison_chart_bytes': " Vergleich (doc_output.py)",
