...
def get_complete_chart_mapping() -> dict[str, str]:
    ...
    return {
        # === AUS CALCULATIONS.PY ===
        'monthly_prod_cons_chart_bytes': "[CHART] Monatl. Produktion/Verbrauch (calculations.py)",
        'cumulative_cashflow_chart_bytes': "[MONEY] Kumulativer Cashflow (calculations.py)",
        'pv_usage_chart_bytes': "☀️ PV-Nutzung (calculations.py)",
        'consumption_coverage_chart_bytes': "[POWER] Verbrauchsdeckung (calculations.py)",
        'cost_overview_chart_bytes': "💵 Kostenübersicht (calculations.py)",
        'cost_projection_chart_bytes': "[STATS] Kostenprojektion (calculations.py)",
        'break_even_scenarios_chart_bytes': "⏱️ Break-Even Szenarien (calculations.py)",
        'technical_degradation_chart_bytes': "[TOOL] Technische Degradation (calculations.py)",
        'maintenance_schedule_chart_bytes': "🛠️ Wartungsplan (calculations.py)",
        'energy_price_comparison_chart_bytes': "[IDEA] Energiepreis-Vergleich (calculations.py)",

        # === AUS ANALYSIS.PY (BESTEHEND) ===
        'roi_chart_bytes': "[CHART] ROI-Entwicklung (analysis.py)",
        'energy_balance_chart_bytes': "⚖️ Energiebilanz Donut (analysis.py)",
        'monthly_savings_chart_bytes': "[MONEY] Monatliche Einsparungen (analysis.py)",
        'yearly_comparison_chart_bytes': "📅 Jahresvergleich (analysis.py)",
        'amortization_chart_bytes': "⏱️ Amortisationszeit (analysis.py)",
        'co2_savings_chart_bytes': "[GREEN] CO₂-Einsparung (analysis.py)",
        ...
        'tariff_comparison_chart_bytes': "[MONEY] Tarif-Vergleich (extended)",
        'income_projection_chart_bytes': "[STATS] Einnahmen-Projektion (extended)",
        ...
        'sensitivity_analysis_chart_bytes': "[CHART] Sensitivitäts-Analyse (analysis.py)",
        'optimization_chart_bytes': "⚙️ Optimierungs-Analyse (analysis.py)",
        'performance_metrics_chart_bytes': "[STATS] Performance-Metriken (analysis.py)",
        'comparison_matrix_chart_bytes': "📋 Vergleichs-Matrix (analysis.py)",

        # === AUS DOC_OUTPUT.PY ===
        'summary_chart_bytes': "[FILE] Zusammenfassung (doc_output.py)",
        ...
        'yearly_production_switcher_chart_bytes': "[CHART] Jahresproduktion (3D)",
        ...
        'prod_vs_cons_switcher_chart_bytes': "[POWER] Produktion vs Verbrauch (3D)",
        'tariff_cube_switcher_chart_bytes': "[MONEY] Tarifvergleich Würfel (3D)",
        'co2_savings_value_switcher_chart_bytes': "[GREEN] CO2 Ersparnis vs Wert (3D)",
        ...
        'cost_growth_switcher_chart_bytes': "[STATS] Kostensteigerung (3D)",
        'selfuse_ratio_switcher_chart_bytes': "[CHART] Eigenverbrauchsgrad (3D)",
        'roi_comparison_switcher_chart_bytes': "[CHART] ROI-Vergleich (3D)",
        'scenario_comparison_switcher_chart_bytes': "🔀 Szenario-Vergleich (3D)",
        'tariff_comparison_switcher_chart_bytes': "[MONEY] Stromkosten Vorher/Nachher (3D)",
        'income_projection_switcher_chart_bytes': "💵 Einnahmen-Prognose (3D)",
        'yearly_production_chart_bytes': "[CHART] PV Visuals: Jahresproduktion",
