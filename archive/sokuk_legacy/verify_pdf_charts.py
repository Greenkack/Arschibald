    ...
    try:
        ...
        if len(reader.pages) >= 6:
            ...
            try:
                ...
                print(
                    f"📝 Text auf Seite 6 gefunden: {
                        len(text_content)} Zeichen")
            ...
            return True
        print(
            f"❌ PDF hat nur {len(reader.pages)} Seiten, Seite 6 nicht verfügbar")
        return False
...
def create_simple_test():
    ...
    try:
        ...
        c.drawString(100, 700, "TEST: Seite 6 Charts")
        c.drawString(
            100,
            680,
            f"Verbrauch: {
