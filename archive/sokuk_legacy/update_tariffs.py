...
# Sie können diese Werte hier anpassen, wenn Sie aktuellere Tarife nutzen
# möchten.
correct_feed_in_tariffs = {
    ...
    # Annahme: gleicher Tarif wie >40-100 für über 100 kWp Teil
    '>100kWp_Teileinspeisung': 0.058,
...
try:
    ...
    # Verwenden Sie INSERT OR REPLACE, um den Eintrag für 'feed_in_tariffs' zu
