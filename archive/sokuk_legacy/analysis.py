...
def load_viz_settings(db_load_func: callable | None = None) -> dict[str, Any]:
    ...
    with col_amort2:
        ...
        if amortization_method == "Klassisch (Investition ÷ Jährliche Vorteile)":
            ...
            if annual_savings_analysis > 0 and final_investment_analysis > 0:
                amortization_years_a = final_investment_analysis / annual_savings_analysis
                st.metric(
                ...
                st.session_state.project_data['project_details']['amortization_years'] = amortization_years_a
                st.session_state.project_data['project_details']['annual_savings'] = annual_savings_analysis
            else:
            ...
            if annual_electricity_costs_analysis > 0 and final_investment_analysis > 0:
                ...
                # Berechne, nach wie vielen Jahren die Stromkosten der
                # Investition entsprechen
                amortization_years_b = (
                ...
                st.session_state.project_data['project_details']['amortization_years'] = amortization_years_b
                st.session_state.project_data['project_details']['annual_electricity_costs'] = annual_electricity_costs_analysis
                st.session_state.project_data['project_details']['comparison_years'] = comparison_years_analysis
                st.session_state.project_data['project_details']['total_electricity_costs'] = total_electricity_costs
            else:
