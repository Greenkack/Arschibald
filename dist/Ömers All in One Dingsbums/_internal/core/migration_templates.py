...
"""
    ...
    def add_index_template(
        ...
        unique: bool = False,
        index_name: str = None) -> dict[str, str]:
        """
...
"""
    ...
    def add_foreign_key_template(
        ...
        ondelete: str = "CASCADE") -> dict[str, str]:
        """
...
"""
    ...
    def create_table_template(
        ...
        with_soft_delete: bool = True) -> dict[str, str]:
        """
...
"""
    ...
    def data_migration_template(
        description: str,
        upgrade_sql: str,
        downgrade_sql: str = None) -> dict[str, str]:
        """
