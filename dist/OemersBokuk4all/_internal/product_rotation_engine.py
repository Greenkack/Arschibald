    ...
    try:
        ...
        if hasattr(product_db, 'list_products'):
            ...
            if callable(product_db.list_products):
                ...
                # WICHTIG: Die Datenbank nutzt DEUTSCHE Kategorienamen!
                ...
                if total > 0:
                    ...
                    logger.warning("Produktdatenbank ist LEER!")
            else:
                logger.warning("list_products ist NICHT callable")
        else:
            logger.warning("list_products() Funktion NICHT gefunden in product_db")
