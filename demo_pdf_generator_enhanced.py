...
def demo_enhanced_pdf_generation():
    ...
    pricing_keys = {k: v for k, v in all_keys.items()
                   if any(prefix in k for prefix in ['PV_', 'COMPONENT', 'DISCOUNT', 'VAT', 'TOTAL'])}
    ...
    populated_advanced = generator.populate_template_placeholders(advanced_template)
