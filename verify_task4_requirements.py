...
def verify_requirement_5_5_5_6_5_7():
    ...
    print(f"  [OK] Korrekte Berechnung: {expected_cols} Spalten × "
...
def verify_requirement_5_1_5_2_5_8():
    ...
    print(f"  [OK] Automatische Platzierung: {len(panels)} Module")
    ...
    print(f"  [OK] Begrenzung auf Kapazität: {len(panels)} von 1000")
    
    # Test: Geneigte Dächer (Satteldach)
    panels = place_panels_auto(10.0, 6.0, 15, "Satteldach", 35.0, 6.0)
    print(f"  [OK] Satteldach mit 35° Neigung: {len(panels)} Module")
    
    # Test: Pultdach
    panels = place_panels_auto(10.0, 6.0, 15, "Pultdach", 25.0, 6.0)
    print(f"  [OK] Pultdach mit 25° Neigung: {len(panels)} Module")
...
def verify_requirement_6_2_6_3_6_4():
    ...
    print(f"  [OK] Ohne Entfernung: {len(panels_all)} Module")
    ...
    print(f"  [OK] Mit Entfernung {removed}: {len(panels_filtered)} Module "
    ...
    print(f"  [OK] Ungültige Indizes ignoriert: {len(panels_invalid)} Module")
...
def verify_requirement_7_1_to_7_6():
    ...
    print(f"  [OK] Süd-Aufständerung (15° Neigung): {len(panels_south)} Module")
    
    # Test: Ost-West-Aufständerung
    panels_ew = place_panels_flat_roof(
        10.0, 6.0, 20, mounting_type="east-west", base_z=6.0
    )
    print(f"  [OK] Ost-West-Aufständerung (10° Neigung): "
    ...
    print(f"  [OK] Ost-West reduzierte Kapazität wegen Reihenfilterung")
    ...
    print(f"  [OK] Mit entfernten Modulen: {len(panels_removed)} Module")
...
def main():
    ...
    try:
        ...
        print("=" * 60)
        print("[OK] Alle Requirements erfüllt!")
        print("=" * 60)
        print("\nZusammenfassung:")
        ...
        print(f"\n[ERROR] Verifikation fehlgeschlagen: {e}")
        return 1
