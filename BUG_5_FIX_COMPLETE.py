#!/usr/bin/env python3
"""
[LAUNCH] FINAL SOLUTION: ALLE BUGS BEHOBEN! [LAUNCH]
...
Jetzt werden die BERECHNETEN PREISE ZUERST verwendet! [OK]
...
Firma 2 (Index 1):
  ...
  5. PDF zeigt: 10.290,00 €  [OK] UNTERSCHIEDLICH!
...
Firma 3 (Index 2):
  ...
  5. PDF zeigt: 12.034,00 €  [OK] UNTERSCHIEDLICH!
...
VERIFIZIERUNG:
==============
[OK] Unterschiedliche Produkte pro Firma (Rotation)
[OK] Unterschiedliche Basis-Preise (Neuberechnung)
[OK] Unterschiedliche skalierte Preise (Staffelung: 5%-20%)
[OK] Preise in Seite 8 Position final_end_preis (seite8.yml)
[OK] Jede PDF hat ihre eigenen Preise

DIE APP SOLLTE JETZT FUNKTIONIEREN! [LAUNCH]
"""
