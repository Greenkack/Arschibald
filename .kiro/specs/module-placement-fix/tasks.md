...
- [x] 3. Automatische Belegung reparieren

  - [x] 3.1 Grid-Berechnung korrigieren
  ...
  - [x] 3.2 Platzierungs-Algorithmus optimieren
  ...
  - [x] 3.3 Button "Automatisch belegen" hinzufügen
...
- [x] 4. Manuelle Belegung reparieren

  - [x] 4.1 Modul-Auswahl implementieren
  ...
  - [x] 4.2 Modul-Manipulation implementieren
  ...
  - [x] 4.3 Drag & Drop implementieren
...
- [x] 7. Kollisionserkennung

  - [x] 7.1 Modul-Modul Kollision
...
- [x] 8. Visualisierungs-Verbesserungen
