...
class ProtectedChartPageGenerator:
    ...
    def _create_protected_chart(self, chart_key: str) -> Any:
        ...
        try:
            ...
            chart_image = Image(
                ...
                height=(self.height - 8*cm) * 0.7,  # Leave space for title/desc
                kind='proportional'
            )
        except Exception as e:
            if self.logger:
        ...
        if chart_description:
            description = Paragraph(chart_description, self.chart_description_style)
    ...
    def _get_chart_description(self, chart_key: str) -> Optional[str]:
    ...
    def create_protected_financing_section(
        ...
        description = None
        if description_text:
            description = Paragraph(description_text, self.chart_description_style)
    ...
    def get_protection_summary(self) -> Optional[dict]:
