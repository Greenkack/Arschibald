...
def init_migrations():
    ...
    try:
        ...
        console.print("[/green] Migration environment initialized successfully")
...
def create_migration(
    ...
    try:
        ...
        console.print(f"[/green] Migration created: {revision}")
...
def downgrade_database(
    ...
    try:
        ...
        console.print("[/green] Rollback completed successfully")
...
def show_current():
    ...
    try:
        ...
        if current:
            console.print(f"Current revision:[/green] {current}")
        else:
...
def show_pending():
    ...
    try:
        ...
        if not pending:
            console.print("[/green] No pending migrations")
            return
...
def create_template(
    ...
    try:
        ...
        console.print(f"[/green] Template created: {template_path}")
