...
print("\n[ERROR] FEHLER: 'Keine Analyseergebnisse verfügbar'")
print("\nURSACHE:")
...
print("\n[ERROR] SYMPTOM: Nur 2 Datenblätter (beide PV-Module)")
print("\nMÖGLICHE URSACHEN:")
...
print("\n[SEARCH] Prüfen Sie in der Streamlit App:")
print("\n1. Sidebar → Welcher Tab ist aktiv?")
print("   [OK] Sollte 'Solar Calculator' oder 'Angebotsausgabe' sein")

print("\n2. Im Solar Calculator:")
print("   [OK] Sind ALLE Komponenten konfiguriert?")
print("   [OK] Wurde die Berechnung durchgeführt?")
print("   [OK] Werden Ergebnisse angezeigt (Kosten, Produktion, ROI)?")

print("\n3. In der PDF-UI:")
print("   [OK] Steht 'Keine Analyseergebnisse verfügbar'?")
print("   [OK] Wenn JA → Zurück zu Schritt 1!")
...
print("   [OK] Charts sind auswählbar (26 Diagramme in 6 Kategorien)")
print("   [OK] 3-5 Datenblätter (Module + Inverter + Speicher + Zubehör)")
print("   [OK] 6 Firmendokumente")
print("   [OK] PDF mit allen Inhalten")

print("\n" + "=" * 100)
print("WICHTIG")
print("=" * 100)

print("\n[WARNING]  STREAMLIT SESSION STATE IST FLÜCHTIG!")
