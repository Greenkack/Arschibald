            ...
            try:
                ...
                if section_key_current == "ProjectOverview":
                    ...
                    if pv_details_pdf.get('include_storage'):
                        storage_capacity_pdf = (
                            current_analysis_results_pdf.get('storage_capacity_kwh')
                            or current_analysis_results_pdf.get('battery_capacity_kwh')
                            or current_analysis_results_pdf.get('speicherkapazitaet_kwh')
                            or pv_details_pdf.get('selected_storage_capacity_kwh')
                            or pv_details_pdf.get('battery_capacity_kwh'))
