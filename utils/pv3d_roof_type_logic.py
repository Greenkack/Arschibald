...
def calculate_flat_roof_positions(
    ...
    if actual_modules < module_quantity:
        print(f"   Nur {actual_modules} von {module_quantity} Modulen passen (Flachdach mit Verschattungs-Abstand)")
...
def calculate_pitched_roof_positions(
    ...
    if actual_modules < module_quantity:
        print(f"   Nur {actual_modules} von {module_quantity} Modulen passen (Schrägdach)")
