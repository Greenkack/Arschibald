...
print("\nMögliche Szenarien:")
print("\n1. [OK] NORMAL: Benutzer hat nur Modul + Inverter konfiguriert")
...
print("\n2. [WARNING]  MÖGLICH: Manuelle Auswahl statt Auto-Auswahl")
...
print("\n3. [ERROR] PROBLEM: Speicher ist konfiguriert aber wird nicht erkannt")
