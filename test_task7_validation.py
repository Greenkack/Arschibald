...
def test_7_2_mounting_height():
    ...
    try:
        ...
        if abs(mounting_height_6) < 0.05:
            ...
            print(f"⚠️  INFO: Durchschnittliche Z-Erhöhung = {mounting_height_6:.3f}m")
    ...
    try:
        ...
        if len(configs_max) > 0:
            ...
            if has_extras and best_score > 80:
                ...
                print(f"⚠️  INFO: Score-Verteilung kann variieren")
        ...
        if len(configs_yield) > 0:
            ...
            if best_config.mounting_mode == "south" and best_score > 80:
                ...
                print(f"⚠️  INFO: {best_config.mounting_mode} hat höchsten Score (erwartet: south)")
        ...
        if len(configs_balanced) >= 3:
            ...
            if score_range < 40:
                ...
                print(f"⚠️  INFO: Score-Range ist {score_range:.1f} (erwartet < 40)")
...
def test_7_4_pdf_screenshot_integration():
    ...
    try:
        ...
        try:
            ...
            print(f"⚠️  INFO: make_pv3d_image_flowable() nicht gefunden: {e}")
...
def test_7_5_error_handling():
    ...
    try:
        ...
        try:
            ...
            print(f"⚠️  INFO: Fehler bei leerem project_data: {e}")
        ...
        try:
            ...
            if len(positions) <= 1:
                ...
                print(f"⚠️  INFO: {len(positions)} Module bei negativen Dimensionen")
        ...
        try:
            ...
            print(f"⚠️  INFO: Exception bei extremen Werten: {e}")
        ...
        try:
            ...
            print(f"⚠️  INFO: Exception bei ungültigen Parametern: {e}")
