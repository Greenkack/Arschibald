...
def render_pdf_ui(
    ...
    if submitted_generate_pdf and not st.session_state.pdf_generating_lock_v1:
        ...
        try:
            ...
            try:
                from pdf_generator import create_fallback_pdf, validate_pdf_data
                ...
                if not validation_result['is_valid']:
                    st.warning(
                        f" Unvollständige Daten erkannt: {
                            ', '.join(
                                validation_result['missing_data'])}")
                    ...
                    st.info(
                        f"ℹ {
                            validation_result['warnings']} Warnungen. PDF wird mit verfügbaren Daten erstellt.")
                else:
