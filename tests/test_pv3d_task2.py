...
def test_safe_get_orientation():
    ...
    print("[OK] _safe_get_orientation OK")
...
def test_safe_get_roof_inclination_deg():
    ...
    print("[OK] _safe_get_roof_inclination_deg OK")
...
def test_safe_get_roof_covering():
    ...
    print("[OK] _safe_get_roof_covering OK")
...
def test_roof_color_from_covering():
    ...
    print("[OK] _roof_color_from_covering OK")
