...
class TestCalculatePerEngine:
    ...
    def test_battery_storage_always_single_position(self, engine):
        """Batteriespeicher dürfen auch im Engine-Direktpfad nie mit kWp/kWh multiplizieren."""
        context = CalculationContext(
            capacity_w=10000.0,
            system_capacity_kwp=10.0,
        ...
        assert result.total_price == 3500.0
