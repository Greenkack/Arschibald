...
class TestPDFGeneratorPricingIntegration:
    ...
    def test_pricing_key_generation(self):
        ...
        if generator.key_manager:
            ...
            if key_names:
                total_category_keys = len(
                    component_keys) + len(discount_keys) + len(total_keys)
    ...
    def test_get_key_category(self):
        ...
        assert generator._get_key_category(
            'COMPONENT_MODULES_TOTAL') == 'Komponenten'
        assert generator._get_key_category(
            'DISCOUNT_EARLY_PAYMENT') == 'Rabatte'
        assert generator._get_key_category(
            'SURCHARGE_RUSH_ORDER') == 'Zuschläge'
    ...
    def test_pricing_integration_without_pricing_system(self):
        ...
        # Mock import error for pricing system by patching the import inside
        # the method
