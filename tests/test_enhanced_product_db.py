...
class TestEnhancedProductDatabase:
    ...
    def test_battery_price_ignores_legacy_capacity_multiplier(self, mock_product_db):
        """Batteriespeicher dürfen nie mit Wunsch-kWh oder kWp multipliziert werden."""
        battery_specs = {
            'category': 'Batteriespeicher',
            'model_name': 'Test Battery 10kWh',
            'price_euro': 3500.0,
        ...
        assert mock_product_db.calculate_price_by_method(
            base_price=3500.0,
            quantity=5.0,
            calculate_per='kWp',
            product_specs=battery_specs,
