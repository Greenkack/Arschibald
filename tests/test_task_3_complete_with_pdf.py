...
def create_mock_financing_options():
    ...
    return [{'id': 1,
             ...
             'enabled': True,
             'financing_options': [{'duration_months': 60,
                                    'interest_rate': 4.5,
            ...
            {'id': 2,
             ...
             'payment_type': 'financing',
             'enabled': True,
             'financing_options': [{'duration_months': 84,
                                    'interest_rate': 3.5,
            ...
            {'id': 3,
             ...
             'payment_type': 'financing',
             'enabled': True,
             'financing_options': [{'duration_months': 36,
                                    'interest_rate': 5.5,
...
def verify_task_requirements():
    ...
    requirements = [{'id': '3.1',
                     ...
                     'check': lambda: hasattr(FinancingPageGenerator,
                                              'generate') and hasattr(FinancingPageGenerator,
                                                                      '_get_financing_options')},
                    {'id': '3.2',
                     'description': 'Finanzierungsübersicht-Seite implementiert',
                     'check': lambda: hasattr(FinancingPageGenerator,
                                              '_draw_financing_overview') and hasattr(FinancingPageGenerator,
                                                                                      '_draw_financing_option_box')},
                    {'id': '3.3',
                     'description': 'Detaillierte Finanzierungsberechnung implementiert',
                     'check': lambda: hasattr(FinancingPageGenerator,
                                              '_calculate_monthly_rate') and hasattr(FinancingPageGenerator,
                                                                                     '_draw_financing_details') and hasattr(FinancingPageGenerator,
                                                                                                                            '_draw_financing_calculation_table')}]
