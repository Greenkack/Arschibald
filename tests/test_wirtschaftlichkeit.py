# test_wirtschaftlichkeit.py


# Wir importieren NUR die Funktion, die wir testen wollen.
# Stellen Sie sicher, dass diese Datei im Hauptverzeichnis Ihres Projekts
# liegt.
...
def run_test():
    ...
    mock_analysis_results = {
        ...
        # Wir simulieren hier die monatlichen Listen, die `calculations.py`
        # erzeugt.
        ...
        # Annahme für den Direktverbrauch, da dieser Wert nicht direkt im PDF
        # stand.
        # Annahme: 2500 kWh / Jahr
        "monthly_direct_self_consumption_kwh": [208.33] * 12
    }

    # Leere Dictionaries für die anderen Argumente, da wir sie hier nicht
    # brauchen.
    mock_project_data = {
        "customer_data": {
            "first_name": "Test",
...
if __name__ == "__main__":
    # Diese Zeile sorgt dafür, dass der Test nur ausgeführt wird, wenn man
    # die Datei direkt startet, nicht wenn sie importiert wird.
    run_test()
