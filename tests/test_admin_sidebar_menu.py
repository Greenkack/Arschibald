...
print("-" * 78)
print("[OK] Vertikales Sidebar-Layout (kompakt & übersichtlich)")
print("[OK] Glassmorphism-Effekt mit Backdrop-Filter")
print("[OK] Gradient-Hover & sanfte Slide-Animation")
print("[OK] Aktiver Tab mit Glow-Effekt & Badge")
print("[OK] Icons + Tooltips für jeden Bereich")
print("[OK] Responsive & Touch-friendly")
...
admin_items = {
    ...
    "admin_tab_product_management": ("[PACKAGE]", "Produktverwaltung"),
    ...
    "admin_tab_tariff_management": ("[IDEA]", "Tarifverwaltung"),
    "admin_tab_pdf_design": ("[NOTE]", "PDF-Design"),
    "admin_tab_payment_terms": ("💳", "Zahlungsbedingungen"),
    "admin_tab_visualization_settings": ("[CHART]", "Visualisierung"),
...
print("[LAUNCH] Kompakt, elegant und interaktiv – perfekt für Admin-Bereiche!")
print()
