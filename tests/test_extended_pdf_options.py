...
def test_default_options():
    ...
    assert final_options['product_datasheets'] == [], "Default 'product_datasheets' should be empty list"
    assert final_options['company_documents'] == [], "Default 'company_documents' should be empty list"
...
def test_complete_options_dictionary():
    ...
    print(f"  - company_documents: {len(complete_options['company_documents'])} items")
    print(f"  - selected_charts: {len(complete_options['selected_charts'])} charts")
