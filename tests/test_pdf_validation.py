...
try:
    ...
    print(f'Test 1 (leer): is_valid={result1["is_valid"]}, critical_errors={len(result1["critical_errors"])}')
    ...
    print(f'Test 2 (minimal): is_valid={result2["is_valid"]}, critical_errors={len(result2["critical_errors"])}')
