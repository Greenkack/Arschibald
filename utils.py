...
# die relevanten Umrechnungsfaktoren und den CO2-Faktor des Netzstroms als
# Input.
...
def kwh_to_trees_equivalent(
    ...
    return co2_saved_kg / tree_absorption_kg_co2_per_year
...
def kwh_to_car_km_equivalent(
    ...
    return co2_saved_g / car_co2_g_per_km


def kwh_to_flights_equivalent(
    kwh_savings: float,
    # z.B. für eine bestimmte Strecke wie MUC-PMI und zurück
    flight_co2_kg_per_person: float,
    grid_co2_g_per_kwh: float
) -> float:
    """
    ...
    return co2_saved_kg / flight_co2_kg_per_person
...
if __name__ == '__main__':
    ...
    trees = kwh_to_trees_equivalent(
        test_kwh_savings,
        test_tree_absorption,
        test_grid_co2_factor)
    car_km = kwh_to_car_km_equivalent(
        test_kwh_savings,
        test_car_emission,
        test_grid_co2_factor)
    flights = kwh_to_flights_equivalent(
        test_kwh_savings,
        test_flight_emission,
        test_grid_co2_factor)
