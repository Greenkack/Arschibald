...
class PricingEngine:
    ...
    def apply_modifications(self, base_price: float,
        ...
        try:
            ...
            # Apply percentage-based modifications (consistent with financial
            # helpers)
            discount_amount_pct = calculate_discount_amount(
                price_with_accessories, discount_pct)
            surcharge_amount_pct = calculate_surcharge_amount(
                price_with_accessories, surcharge_pct)
            price_after_percentage_mods = (
                price_with_accessories -
                discount_amount_pct +
                surcharge_amount_pct)

            # Apply fixed modifications
            final_price = price_after_percentage_mods - discount_fixed + surcharge_fixed
