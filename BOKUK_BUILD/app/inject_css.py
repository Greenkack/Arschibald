#!/usr/bin/env python3
"""
Skript zum Einfügen der Slider und Checkbox CSS-Effekte in gui.py
"""

# CSS-Block für Slider und Checkboxen
CSS_INSERT = '''
    # ========================================================================
...
# Finde die Zeile mit "# INTRO-BILDSCHIRM (VOR DER HAUPTANWENDUNG)"
insert_index = None
for i, line in enumerate(lines):
    if '# INTRO-BILDSCHIRM (VOR DER HAUPTANWENDUNG)' in line:
        insert_index = i
        break
...
lines.insert(insert_index, CSS_INSERT)
