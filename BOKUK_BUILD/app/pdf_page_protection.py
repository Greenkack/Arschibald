...
class PageProtectionManager:
    ...
    def check_if_pagebreak_needed(
        ...
        if needs_break:
            self._log_protection(
                ...
                details=f'element_height={element_height:.1f}, available={available_space:.1f}'
            )
    ...
    def handle_oversized_element(
        ...
        self._log_protection(
            ...
            details=f'max_height={max_height:.1f}, allowing_reportlab_auto_split'
        )
    ...
    def add_spacing_with_pagebreak_check(
        ...
        self._log_protection(
            ...
            details=f'spacing={spacing:.1f}, min_space={min_space_for_next:.1f}'
        )
...
def create_protected_chart_element(
    ...
    styles: dict,
    chart_key: str = "",
    protection_manager: Optional[PageProtectionManager] = None
) -> Flowable:
