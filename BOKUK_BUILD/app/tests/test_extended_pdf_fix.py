...
def test_extended_options_building():
    ...
    if pdf_inclusion_options.get('extended_output_enabled', False):
        extended_options = {
            'financing_details': pdf_inclusion_options.get('include_financing_details', False),
            'product_datasheets': pdf_inclusion_options.get('selected_product_datasheets', []),
            'company_documents': pdf_inclusion_options.get('company_document_ids_to_include', []),
            'charts': pdf_inclusion_options.get('selected_charts_for_pdf', []),
            'chart_layout': pdf_inclusion_options.get('chart_layout', 'one_per_page')
        }
    ...
    assert extended_opts['financing_details'] == True
