...
keys = [
    ...
    ("payback_time", "Verschiedene Module", "Mehrfachverwendung"),
    ("payback_period", "Alte Berechnungen", "Veraltet"),
    ("payback_period_years", "calculations_heatpump.py", "Nur für Wärmepumpe"),
    ("co2_payback_years", "CO2-Amortisation", "Nur für CO2"),
    ("carbon_payback_time", "CO2-Amortisation", "Nur für CO2"),
