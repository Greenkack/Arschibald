    ...
    if template_structure['templates']:
        ...
        for i in range(1, 9):
            ...
            if key in template:
                ...
                print(f"Template key '{key}' fehlt (optional)")
...
def test_file_path_validation():
    ...
    for path, should_exist in test_paths:
        ...
        if exists:
            ...
            print(f"Datei existiert nicht: {path} (wird für Template benötigt)")
