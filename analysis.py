...
try:
    ...
    def trace_analysis(func):
        def wrapper(*args, **kwargs):
            start_time = time.time()
            op_name = f"analysis.{func.__name__}"
            try:
    ...
    def trace_analysis(func): return func
...
def render_storage_effect_switcher(
    ...
    current_storage_cap_kwh_raw = (
        analysis_results.get("storage_capacity_kwh")
        or analysis_results.get("battery_capacity_kwh")
        or analysis_results.get("speicherkapazitaet_kwh")
    )
